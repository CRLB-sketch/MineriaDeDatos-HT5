...
``` {r}
y4_reg <- test_set[,c("salePrice")]
y_pred_4_reg <- predict(model_naive_bayes, newdata = test_set)
rmse_model_4_reg <- RMSE(pred = y_pred_4_reg, obs = test_set$salePrice)
abs_error_4_reg <- abs(mean(y_pred_4_reg - test_set$salePrice))
mean_error_4_reg <- mean(y4_reg - y_pred_4_reg)
print(mean_error_4)
```
