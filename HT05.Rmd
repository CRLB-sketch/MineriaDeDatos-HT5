...
pred_bayes <- predict(model_naive_bayes, newdata=test_set)

table_confusion <- table(pred_bayes, test_set$salePrice)
...
``` {r}
model_clasification <- rpart(economy ~ ., data = train_set, method = "class")
